                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img src="<?= $tour['tour_image'] ?>" width="150"
                                        class="img-thumbnail mb-2 shadow-sm">
                                    <input type="file" class="form-control" name="image" accept="image/*">
                                    <small class="text-muted">اگر نمی‌خواهید عکس تغییر کند، این بخش را خالی
                                        بگذارید.</small>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button name="update" class="btn btn-warning px-5 fw-bold text-dark">بروزرسانی نهایی
                                        تور</button>
                                    <a href="exhibition_tours.php" class="btn btn-outline-secondary px-4">بازگشت به
                                        لیست</a>
                                </div>
                            </form>
                        </div>
