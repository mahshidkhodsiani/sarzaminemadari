    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($errors)) {
            ...
            $stmt = $conn->prepare("INSERT INTO tour_requests 
                                   (name, phone, email, tour_id, passengers, notes, request_date) 
                                   VALUES (?, ?, ?, ?, ?, ?, NOW())");
            $stmt->bind_param("ssssis", $name, $phone, $email, $post_tour_id, $passengers, $notes);
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form method="post" action="" class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($email); ?>" placeholder="اختیاری: example@domain.com">
                                    <div class="invalid-feedback">
